    ...
    <div class="w-full max-w-md bg-white p-8 rounded-lg shadow-md">
        ...
        <form method="POST" action="/login">
            ...
            <div class="mb-4">
                ...
                <input id="email" type="email" name="email" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline @error('email') is-invalid @enderror" required autofocus value="{{ old('email') }}">
                @error('email')
            ...
            <div class="mt-4 text-center">
              <p class="text-gray-700 text-sm">Don't have an account? 
                  <a href="/register" class="text-blue-500 hover:text-blue-800 font-bold">Register</a>
              </p>
          </div>
        </form>
    </div>
