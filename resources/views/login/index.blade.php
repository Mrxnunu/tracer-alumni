    ...
    <div class="w-full max-w-md bg-white p-8 rounded-lg shadow-md">
        ...
        <form method="POST" action="/login">
            ...
            <div class="flex items-center justify-between">
                <button type="submit" class="bg-amber-500 hover:bg-amber-700 text-white font-bold py-2 px-3 rounded focus:outline-none focus:shadow-outline">
                    Login
                </button>
            </div>
            ...
            @if(session()->has('loginError'))
                <div class="bg-red-100 border border-red-400 text-red-700 mt-2 py-2 px-3 rounded relative" role="alert">
