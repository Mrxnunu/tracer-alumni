    ...
    <div class="w-full sm:w-1/2 lg:w-1/3 px-3 mb-6">
      <div class="bg-white shadow-md rounded-lg overflow-hidden">
        ...
        <div class="p-6">
          ...
          <p class="text-gray-600 mb-4">
            <small>By. <a href="/artikel?authors={{ $post->author->username ?? 'Tidak ada author' }}" class="text-blue-500 hover:underline">{{ $post->author->username ?? 'Tidak ada author' }}</a> {{ $post->created_at->diffForHumans() }}</small>
          </p>
