  ...
  <nav class="flex px-5 py-3 text-gray-700 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <div class="flex items-center">
                ...
                <a href="/dashboard/loker" class="ms-1 text-sm font-medium text-gray-700 md:ms-2 dark:text-gray-400 dark:hover:text-amber-600 hover:text-amber-600">Loker</a>
            </div>
            </li>
            <div class="flex items-center">
                <svg class="rtl:rotate-180 block w-3 h-3 mx-1 text-gray-400 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 6 10">
                ...
                <a href="/dashboard/loker/create" class="ms-1 text-sm font-medium text-amber-600 md:ms-2 dark:text-amber-600 dark:hover:text-amber-600">Tambah Data loker</a>
            </div>
            </li>
        </ol>
  </nav>
  <div class="py-5">
    <form method="post" action="/dashboard/loker" class="w-full" enctype="multipart/form-data">
        @csrf
        <h2 class="text-2xl leading-tight font-medium mb-2 dark:text-white">Buat Data Lowongan Kerja</h2>
          <div class="mb-5">
            <label for="title" class="block mb-2 text-sm font-medium text-grey-700 dark:text-grey-500">Judul Loker</label>
            <input type="text" id="title" name="title" class="bg-grey-50 border border-grey-500 text-grey-900 dark:text-grey-400 placeholder-grey-700 dark:placeholder-grey-500 text-sm rounded-lg focus:ring-amber-500 focus:border-amber-500 block w-full p-2.5 dark:bg-gray-700 dark:border-grey-500 @error('title') is-invalid @enderror" required autofocus value="{{ old('title') }}">
            @error('title')
          ...
          <div class="mb-5">
            <label class="block text-sm font-medium text-grey-700 dark:text-grey-500" for="image">Foto Loker</label>
          ...
          <div class="mb-5">
              <label for="body" class="block mb-2 text-sm font-medium text-grey-700 dark:text-grey-500">Isi Lowongan Kerja</label>
              @error('body')
