                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="md:flex md:gap-2 px-5 py-5 border-b border-gray-200 bg-dark text-sm">
                                    ...
                                    <button type="button" class="flex-shrink-0 px-4 py-2 font-medium text-white bg-red-500 rounded-lg shadow-md hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-green-200">
                                        Delete
                                    </button>
                                </td>
                            </tr>
