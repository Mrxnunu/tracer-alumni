...
<div class="px-4 sm:px-8">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="/dashboard/alumni" class="ms-1 text-sm font-medium text-amber-600 md:ms-2 dark:text-amber-600">Alumni</a>
                </div>
            </li>
            <li>
                <div class="flex items-center">
                    ...
                    <span class="ms-1 text-sm font-medium text-gray-400 md:ms-2 dark:text-gray-500">Detail</span>
                </div>
            </li>
        </ol>
    </nav>
    <div class="py-5">
        ...
        <div class="mt-4">
            ...
            <p><strong>Title:</strong> {{ $questionnaireTitle }}</p>
