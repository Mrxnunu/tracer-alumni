        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="/dashboard/alumni" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-amber-600 dark:text-gray-400 dark:hover:text-amber-600">Alumni</a>
                </div>
            </li>
            <li>
                <div class="flex items-center">
            ...
            <table class="min-w-full mt-2 bg-white">
                ...
                <tbody class="dark:bg-slate-900">
                    @foreach ($jawaban as $jwb)
                        <tr>
                            <td class="px-5 py-5 border-b border-gray-200 dark:border-gray-400 text-sm">{{ DB::table('questions')->where('id', $jwb->question_id)->value('question_text') }}</td>
