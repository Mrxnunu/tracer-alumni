        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="/dashboard/pertanyaan" class="ms-1 text-sm font-medium text-gray-700 hover:text-amber-600 dark:text-gray-400 dark:hover:text-amber-600">Kuisioner</a>
                </div>
            </li>
            <li>
                <div class="flex items-center">
                    ...
                    <span class="ms-1 text-sm font-medium text-amber-600 md:ms-2">Detail Responden</span>
                </div>
            </li>
        </ol>
    </nav>
    <div class="py-5">
        <h2 class="text-2xl leading-tight font-medium">Detail Responden</h2>
