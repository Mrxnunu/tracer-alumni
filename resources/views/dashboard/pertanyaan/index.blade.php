...
<div class="px-4 sm:px-8">
    ...
    <nav class="flex px-5 py-3 text-gray-700 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-800 dark:border-gray-700" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <div class="flex items-center">
                ...
                <a href="/dashboard/pertanyaan" class="ms-1 text-sm font-medium text-amber-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Kuisioner</a>
            </div>
            </li>
        </ol>
    </nav>
    <div class="py-5">
        <div class="flex flex-row mb-1 sm:mb-0 justify-between w-full items-center">
            <h2 class="text-2xl leading-tight font-medium">Master Kuisioner</h2>
