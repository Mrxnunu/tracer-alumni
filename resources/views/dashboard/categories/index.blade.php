                    ...
                    <table id="" class="min-w-full leading-normal">
                        ...
                        <tbody class="dark:bg-slate-900">
                            ...
                            <tr>
                                ...
                                <td class="px-5 py-5 border-b border-gray-200 dark:border-gray-400 text-sm">
                                    <p class="text-gray-900 dark:text-gray-300 whitespace-no-wrap">{{ $c->name }}</p>
                                </td>
                                <td class="px-5 py-5 border-b border-gray-200 dark:border-gray-400 text-sm">
                                    <p class="text-gray-900 dark:text-gray-300 whitespace-no-wrap">{{ $c->slug }}</p>
                                </td>
                                <td class="grid gap-1 md:flex md:gap-2 px-4 py-5 border-b border-gray-200 dark:border-gray-400 text-sm">
