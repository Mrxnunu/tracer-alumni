    ...
    <div class="px-4 sm:px-8">
        ...
        <div class="py-5">
            <form method="post" action="/dashboard/posts/{{ $post->id }}" class="w-full" enctype="multipart/form-data">
                ...
                <div class="mb-5">
                    <label for="title" class="block mb-2 text-sm font-medium text-gray-700 dark:text-gray-500">Judul</label>
                ...
                <div class="mb-5">
                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-500" for="image">Foto Artikel</label>
