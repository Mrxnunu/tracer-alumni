        ...
        <div class="py-5">
            <form method="post" action="/dashboard/posts/{{ $post->id }}" class="w-full" enctype="multipart/form-data">
                ...
                <div class="mb-5  text-gray-700 ">
                    <label for="title" class="block mb-2 text-sm font-medium dark:text-gray-500">Judul</label>
                ...
                <div class="mb-5 text-gray-700">
                    <label for="category_id" class="block mb-2 text-sm font-medium dark:text-gray-500">Pilih Kategori</label>
                ...
                <div class="mb-5 text-gray-700">
                    <label class="block mb-2 text-sm font-medium dark:text-gray-500" for="image">Foto Artikel</label>
